...
import com.zs.ssh.utils.impl.FileUploadUtil;
...
public class InitDataListener implements ServletContextListener {
	...
	private FileUploadUtil fileUpload = null;
	...
	public void contextInitialized(ServletContextEvent event) {
		...
		//获取银行图片，并放到application中
		fileUpload = context.getBean(FileUploadUtil.class);
