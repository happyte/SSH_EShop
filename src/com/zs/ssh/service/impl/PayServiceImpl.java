...
import com.zs.ssh.utils.impl.DigestUtil;

@Service
public class PayServiceImpl extends BaseServiceImpl<Forder> implements PayService {
	//三个属性都是固定值，我将它们放到pay.properties配置文件中了，到时候直接取即可
	//密钥
	@Value("#{prop.key}")
	private String key;
	//商家账号
	...
	public boolean checkBackData(BackData backData) {
		String joinParam = joinBackDataParam(backData);
